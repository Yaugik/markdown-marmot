...
import { createIssueSavedView, type IssueSavedView } from "@/services/issue-views";
...
const responseView = (view: IssueSavedView) => ({
  id: view.id,
  workspace_id: view.workspaceId,
  project_id: view.projectId,
  owner_principal_id: view.ownerPrincipalId,
  name: view.name,
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const views = await listIssueSavedViewsWithPolicy({
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const result = await createIssueSavedView({
