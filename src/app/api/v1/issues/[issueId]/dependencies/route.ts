...
import { listReadableIssueDependencies } from "@/services/issue-relation-reads";
import { addIssueDependency, type IssueDependency } from "@/services/issue-relations";
...
const responseDependency = (item: IssueDependency) => ({
  id: item.id,
...
export async function GET(request: Request, { params }: RouteContext) {
  ...
  try {
    ...
    const dependencies = await listReadableIssueDependencies({
...
export async function POST(request: Request, { params }: RouteContext) {
  ...
  try {
    ...
    return jsonSuccess({
      dependency: responseDependency(result.data),
