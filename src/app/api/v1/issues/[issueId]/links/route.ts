...
import { listReadableIssueLinks } from "@/services/issue-relation-reads";
import { addIssueLink, type IssueLink } from "@/services/issue-relations";
...
const responseLink = (item: IssueLink) => ({
  id: item.id,
  issue_id: item.issueId,
  link_kind: item.linkKind,
  target_issue_id: item.targetIssueId,
  target_page_id: item.targetPageId,
...
export async function GET(request: Request, { params }: RouteContext) {
  ...
  try {
    ...
    const links = await listReadableIssueLinks({
